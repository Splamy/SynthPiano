...
namespace NodeGen.Views
{
	public partial class BaseNodeView : IViewFor<BaseNodeViewModel>
	{
		...
		private Brush ConvertNodeTypeToBrush(NodeType type)
		{
			return type switch
			{
				NodeType.EventNode => new SolidColorBrush(Color.FromRgb(0x9b, 0x00, 0x00)),
				NodeType.FlowControl => new SolidColorBrush(Color.FromRgb(0x49, 0x49, 0x49)),
				NodeType.Function => new SolidColorBrush(Color.FromRgb(0x00, 0x39, 0xcb)),
				NodeType.Literal => new SolidColorBrush(Color.FromRgb(0x00, 0x60, 0x0f)),
